    ...
    return(
        ...
        <div className="grid grid-cols-3 text-sm">
            <div className='col-start-2 col-end-3'>
                <p className="font-bold text-xl mb-5">Add New Campground</p>
                <p>Campground Name</p>
                <input type="text" placeholder='Seven Sisters Waterfall' className='rounded bg-stone-100 p-2 w-full mt-3'/>
                <p className='mt-3'>Price</p>
                <input type="number" placeholder='$149' className='bg-stone-100 w-full p-2 mt-3 rounded'/>
                ...
                <textarea className='bg-stone-100 rounded mt-3 w-full h-full' id="Description" type="text" placeholder='The Seven Sisters is the 39th tallest waterfall in Norway. The 410-metre tall waterfall consists of seven separate streams, and the tallest of the seven has a free fall that measures 250 meters. The water is located along the Geirangerfjoden in Stranda Municipality in More og Romsdal county, Norway.'></textarea>
