            ...
            <div className="grid grid-cols-5">
                <div className="col-span-3 m-10 p-10">
                    ...
                    <div className="mt-20">
                        ...
                        <input type="password" placeholder="Choose Password" className="bg-stone-100 rounded p-3 w-full"/>
                    </div>
                    <button className="rounded bg-black text-white p-3 w-full mt-3">Create an account</button>
