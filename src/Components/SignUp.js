            ...
            <div className="grid grid-cols-1 lg:grid-cols-5">
                <div className="m-5 p-2 lg:col-span-3 lg:m-10 lg:p-10">
                    ...
                    <form className="mt-20">
                        ...
                        <input id="username" value={name} onChange={(e)=>setName(e.target.value)} className="bg-stone-100 rounded p-3 w-full" type="text" placeholder='johndoe_91'/>
                        <label className="mt-3 mb-3" for="password">Password</label>
                        <input type="password" value={password} onChange={(e)=>setPassword(e.target.value)} placeholder="Choose Password" id="password" className="bg-stone-100 rounded p-3 w-full"/>
                    </form>
