    ...
    return(
        <>
            <div className="relative flex mt-5 mr-5 ml-5 mb-10">
                ...
                <Link to="/menu"><button onClick={()=>{setMenu(!menu)}} className='absolute right-0 rounded bg-stone-100 block lg:hidden'><img src={HamburgerMenu} alt="Hamburger Menu"/></button></Link>
                {/* <Link to="/Login"><p className="hidden lg:block p-2">Login</p></Link>
                <Link to="/signup"><button className="hidden lg:block bg-black text-white rounded p-2">Create an account</button></Link> */}
               
                {
                        logIn ? (
                            ...
                            <div className='absolute right-0'>
                                ...
                                <Link to="/signup"><button className="hidden lg:inline bg-black text-white rounded p-2">Create an account</button></Link>
